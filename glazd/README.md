# Glazd — Legal Resources

This directory contains all legal documentation required for the **Glazd** mobile application.

## 🔗 Quick Links for Google Play Console

Copy and paste these URLs into the Google Play Console "App Content" section:
